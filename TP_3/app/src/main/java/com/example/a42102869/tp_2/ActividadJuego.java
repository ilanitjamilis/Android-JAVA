...
public class ActividadJuego extends AppCompatActivity {
    ...
    public void apretoBtn (View vista) {
        ...
        if(movimientosUtilizados == utilidades.mejorPuntaje+1){
            mensaje = "Ha superado la cantidad de jugadas que utilizó en su mejor jugada";
    ...
    public void ganoJuego (){
        ...
        if(movimientosUtilizados < utilidades.mejorPuntaje){
            paqueteDatos.putString("caso","gano");
            utilidades.mejorPuntaje = movimientosUtilizados;
    ...
    public void ActualizarCantJugadas(){
        boolean miBaseDeDatosAbierta = utilidades.baseDeDatosAbierta(this);
        if(miBaseDeDatosAbierta){

            Integer cantJugadasActualizar = utilidades.partidasRegistradas+1;
            String nombreJugadorParaActualizar = utilidades.nombreJugador;

            utilidades.baseDatos.execSQL("UPDATE jugadores SET cantJugadas=" + cantJugadasActualizar + " WHERE nombre='"+nombreJugadorParaActualizar+"'");
            utilidades.partidasRegistradas = cantJugadasActualizar;
        }
    ...
    public void ActualizarRecord(){
        ...
        if(miBaseDeDatosAbierta){
            ...
            Integer recordActualizar = movimientosUtilizados;
            String nombreJugadorParaActualizar = utilidades.nombreJugador;

            utilidades.baseDatos.execSQL("UPDATE jugadores SET record=" + recordActualizar + " WHERE nombre='"+nombreJugadorParaActualizar+"'");
        }
        utilidades.baseDatos.close();
    }
