...
public class ActividadPrincipal extends AppCompatActivity {
    ...
    public void irVerEstadisticas(View vista){
        Intent irVerEstadisticas;
        irVerEstadisticas = new Intent (ActividadPrincipal.this, ActividadVerEstadisticas.class);
        startActivity(irVerEstadisticas);
    }
}
